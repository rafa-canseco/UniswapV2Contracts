...
import {DAI,WETH,UNISWAP_V2_ROUTER_02,UNISWAP_V2_PAIR_DAI_WETH} from "../../../src/interfaces/Constants.sol";
...
contract UniswapV2LiquidityTest is Test {
    ...
    function test_addLiquidity() public {
        ...
        (uint256 amountA, uint256 amountB, uint256 liquidity) = router.addLiquidity
            ({tokenA:DAI,
            tokenB:WETH,
            amountADesired: 69 * 1e18,
            amountBDesired: 420 * 1e18,
            amountAMin: 1,
            amountBMin: 1,
            to:user,
        ...
        console2.log("amount of shares minted",pair.balanceOf(user));
        // Check that the user receive shares for adding liquidity
    ...
    function test_removeLiquidity() public {
        ...
        vm.stopPrank();
        console2.log("assetA DAI received",amountA);
        console2.log("AssetB WETH received",amountB);
